...
class SegmentMetric(Base):
    ...
    dimension: Mapped[str] = mapped_column(Text, nullable=False)        # "segment" or "geography"
    dimension_value: Mapped[str] = mapped_column(Text, nullable=False)  # e.g. "iPhone", "Americas"
